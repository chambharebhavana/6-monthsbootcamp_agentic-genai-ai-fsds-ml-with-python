...
def add_student():
    ...
    if not studentname or not coursename or not fee or not gender or not branch:
    ...
    try:
        ...
        sql = "INSERT INTO registration (name, course, fee, gender, branch) VALUES (%s, %s, %s, %s, %s)"
        values = (studentname, coursename, fee, gender, branch)
...
def update_student():
    ...
    try:
        ...
        sql = "UPDATE registration SET name=%s, course=%s, fee=%s , gender=%s, branch=%s WHERE id=%s"
        values = (studentname, coursename, fee, gender, branch, studentid)
...
def on_treeview_select(event):
    ...
    if selected_item:
        ...
        studentid, studentname, coursename, fee, gender, branch = student['values']
...
cols = ("id", "name", "course", "fee", "gender", "branch")
